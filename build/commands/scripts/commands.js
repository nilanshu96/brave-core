...
program
  ...
  .option('--ftx_client_id <ftx_client_id>')
  .option('--ftx_client_secret <ftx_client_secret>')
  ...
  .option('--gemini_api_url <gemini_api_url>')
  .option('--gemini_api_staging_url <gemini_api_staging_url>')
  .option('--gemini_oauth_url <gemini_oauth_url>')
  .option('--gemini_oauth_staging_url <gemini_oauth_staging_url>')
  .option('--gemini_wallet_client_id <gemini_wallet_client_id>')
  .option('--gemini_wallet_client_secret <gemini_wallet_client_secret>')
  .option('--gemini_wallet_staging_client_id <gemini_wallet_staging_client_id>')
  .option('--gemini_wallet_staging_client_secret <gemini_wallet_staging_client_secret>')
